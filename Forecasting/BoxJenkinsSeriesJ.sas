  ...
  /*                                                              */
  /*    NAME: arimaex3                                            */
  /*   TITLE: ARIMA: Models for Series J from Box-Jenkins         */
  /* PRODUCT: ETS                                                 */
  /*  SYSTEM: ALL                                                 */
  /*    KEYS: time series analysis, transfer function modeling,   */
  /*    KEYS: autocorrelation                                     */
  /*   PROCS: ARIMA                                               */
  /*    DATA: Box and Jenkins, Series J                           */
  /*                                                              */
  /*     REF: Box, G.E.P. and Jenkins, G.M. (1976), Time Series   */
  /*          Analysis:  Forecasting and Control, San Francisco:  */
  /*          Holden-Day.                                         */
  /*    MISC:                                                     */
  /*                                                              */
  /****************************************************************/
  /* Example 3.3 Model for Series J Data from Box and Jenkins */
  /* Chapter 3 page 169 */
