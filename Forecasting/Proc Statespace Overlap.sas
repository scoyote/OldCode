...
data temp1;
     set statespaceforecast;
          l95_1=for1-1.65*std1;
          u95_1=for1+1.65*std1;
          l95_2=for2-1.65*std2;
          u95_2=for2+1.65*std2;
          &output=&output;
     /* pull out the predicted values to be compared with the predictions */
     /* figure out if there are 1 or 2 regions */
 run; 
 /* if at any time there is an overlap*/
data temp2; set temp1;
     if u95_1>=u95_2 then ucat=1;
     else ucat=2;
     if l95_1>=l95_2 then lcat=1;
     else lcat=2; 
     if u95_1>max(l95_1,l95_2) then u1_lcat=1;
     else u1_lcat=2;
     if u95_2>max(l95_1,l95_2) then u2_lcat=1;
     else u2_lcat=2;
run;
...
run; 
     ...
     data out(  drop=    sval1_1 sval1_2 sval2_1 sval2_2 sval3_1 sval3_2)
          low1( keep=dtm sval1_1 sval1_2 sval2_1 sval2_2 sval3_1 sval3_2)
          high1(keep=dtm sval1_1 sval1_2 sval2_1 sval2_2 sval3_1 sval3_2)
          low2( keep=dtm sval1_1 sval1_2 sval2_1 sval2_2 sval3_1 sval3_2)
          high2(keep=dtm sval1_1 sval1_2 sval2_1 sval2_2 sval3_1 sval3_2)
          low3( keep=dtm sval1_1 sval1_2 sval2_1 sval2_2 sval3_1 sval3_2)
          high3(keep=dtm sval1_1 sval1_2 sval2_1 sval2_2 sval3_1 sval3_2);
     set temp1;
          output out;

     if dtm > &fcref and  dtm <= &enddate then do; 
          sval1_1=l95_1; 
          sval1_2=l95_2;
          output low1; 
          sval1_1=u95_1;
     ...
     proc sort data=low3; by descending dtm; run;
     data forecast; set low3 high3 low2 high2 low1 high1 out; 
          if dtm=. then delete; 
     run;
...
goptions reset   = all;
    ...
    * label sval0="1 Step Ahead CI" sval1="Holdout Data Forecast CI" sval2="Forecast CI" forecast='Forecast' &output='Actual';
     ...
     symbol5 i=j       v=none   l=3   h=1    w=1  c=degb;
     symbol6 i=none    v=dot          h=.33  w=1  c=vigb;
     where dtm between &plotstart and &plotend;
     format dtm tod5.;
     plot sval3_1*dtm=1 
          sval1_1*dtm=2 
