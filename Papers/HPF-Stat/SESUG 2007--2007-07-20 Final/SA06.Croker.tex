...
\sugconfsubject{SESUG 2007, Statistics and Data Analysis}
\sugconfpapernumber{Paper SA06}
\sugconfkeywords{Base SAS, SAS High-Performance Forecasting, PROC HPFENGINE, PROC HPFARIMASPEC, SAS/GRAPH}
...
\figcaption{Edisto River Near Givhans, SC: July 18th--20th, 2007}
\label{fig:Givhans}
\end{minipage}
