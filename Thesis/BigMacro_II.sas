				...
				%do ar_md=0 %to 5;
					%do ma_md=0 %to 5;
						...
						proc arima data=&dataset;
							...
							identify var=&outputvar1 scan crosscorr=(&inputvar1) nlag=20 noprint;*outcov=outcov_&modelid noprint ;*prewhitening step; 
							estimate p=&ar_md q=&ma_md input=(3$(1)/(1)&inputvar1) noprint plot method=ml /*outest=outest outmodel=outmodel*/ outstat=outstat_&modelid ;
...
libname saluda 'C:\Documents and Settings\Samuel\My Documents\Thesis Final\';
options NOMLOGIC NOMPRINT NOMRECALL NOSYMBOLGEN NOMAUTOSOURCE;

%let startdate=		'01jan98/00:00:00'DT;
%let enddate=		'01jan00/00:00:00'DT;
...
%let inputvar1=	    logcong9500_flow;
...
quit;
proc printto ;*log='C:\Documents and Settings\Samuel\My Documents\Thesis Final\Thesis Final\arima.log' new;
run;
