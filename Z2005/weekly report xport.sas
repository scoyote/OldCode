...
libname tran xport 'd:\workspace\xport'; /*LOCATION OF DOWNLOADED MAINFRAME DATA*/
...
data new_supp(drop=PRV_NO LCTN_NO);
set w.new_supp;
label SUPPID='SUPPLIER NUMBER'; 
label STATUS='STATUS';
label COMPANY='COMPANY';
...
****READ IN DDE MACRO;
options source2;
%include 'd:\sastoexcel_nsc_parta.sas';
...
%let setup=October 5, 2009 - October 11, 2009; /*REPORT SETUP DATE RANGE*/
